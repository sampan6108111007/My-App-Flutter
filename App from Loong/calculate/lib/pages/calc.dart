...
class _CalculatePageState extends State<CalculatePage> {
  ...
  @override
  void initState() {
    // ฟังก์ชั่นพิเศษที่ใช้สำหรับการตั้งค่าตอนแรก
    super.initState();

    result.text =
        "ซื้อแอปเปิ้ลจำนวน x ผล ราคาผลละ x บาท รวมลูกค้าต้องจ่ายทั้งหมด x บาท";
  }
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  setState(() {
                    result.text =
                        "ซื้อแอปเปิ้ลจำนวน ${quantity.text} ผล ราคาผลละ ${price.text} บาท รวมลูกค้าต้องจ่ายทั้งหมด $cal บาท";
                  });
                },
                child: Text("คำนวณ"),
                style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all(Color(0xff60e00b)),
